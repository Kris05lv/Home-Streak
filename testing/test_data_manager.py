...
def test_save_habit(test_habit):
...
def test_save_bonus_habit(test_bonus_habit):
...
def test_complete_habit(test_habit, test_user):
...
def test_claim_bonus_habit(test_bonus_habit, test_user):
...
def test_reset_monthly_scores(test_user, test_habit):
...
def test_load_habits(test_habit, test_bonus_habit):
...
def test_reset_habits(test_habit, test_user):
    """Test habit reset functionality."""
    DataManager.save_habit(test_habit)
    DataManager.complete_habit("testuser", "TestHabit")
    DataManager.reset_habits()
    data = DataManager.load_data()
    # Check that the streak has been reset
